...
if (siteNavigationMenu != null) {
                ...
                if (_jspx_eval_liferay$1frontend_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  if (_jspx_eval_aui_select_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                    ...
                    do {
                      ...
                      _jspx_th_c_if_0.setTest( scopeGroup.hasPublicLayouts() && layout.isPublicLayout() );
                      ...
                      _jspx_th_c_if_1.setTest( scopeGroup.hasPrivateLayouts() && layout.isPrivateLayout() );
                      ...
                      _jspx_th_aui_option_2.setLabel(new String("primary-navigation"));
                      _jspx_th_aui_option_2.setSelected( siteNavigationMenuDisplayContext.getSelectSiteNavigationMenuType() == SiteNavigationConstants.TYPE_PRIMARY );
                      _jspx_th_aui_option_2.setValue( SiteNavigationConstants.TYPE_PRIMARY );
                      ...
                      _jspx_th_aui_option_3.setLabel(new String("secondary-navigation"));
                      _jspx_th_aui_option_3.setSelected( siteNavigationMenuDisplayContext.getSelectSiteNavigationMenuType() == SiteNavigationConstants.TYPE_SECONDARY );
                      _jspx_th_aui_option_3.setValue( SiteNavigationConstants.TYPE_SECONDARY );
                      ...
                      _jspx_th_aui_option_4.setLabel(new String("social-navigation"));
                      _jspx_th_aui_option_4.setSelected( siteNavigationMenuDisplayContext.getSelectSiteNavigationMenuType() == SiteNavigationConstants.TYPE_SOCIAL );
                      _jspx_th_aui_option_4.setValue( SiteNavigationConstants.TYPE_SOCIAL );
                  ...
                  _jspx_th_c_if_2.setTest( siteNavigationMenuDisplayContext.isSiteNavigationMenuSelected() && (siteNavigationMenu != null) );
                ...
                if (_jspx_eval_liferay$1frontend_fieldset_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                    ...
                    if (_jspx_eval_aui_col_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      ...
                      if (_jspx_eval_aui_select_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                        ...
                        do {
                          ...
                          _jspx_th_aui_option_8.setLabel( i );
                          _jspx_th_aui_option_8.setSelected( siteNavigationMenuDisplayContext.getRootMenuItemLevel() == i );
                  ...
                  if (_jspx_eval_aui_row_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                    ...
                    if (_jspx_eval_aui_col_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      ...
                      out.write("\" id=\"");
                      if (_jspx_meth_portlet_namespace_4((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_col_3, _jspx_page_context))
                        return;
                      ...
                      if (_jspx_meth_aui_icon_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_col_3, _jspx_page_context))
                        return;
                  ...
                  if (_jspx_eval_aui_row_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                    ...
                    if (_jspx_eval_aui_col_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      ...
                      if (_jspx_eval_aui_select_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                        ...
                        do {
                          out.write("\n\t\t\t\t\t\t\t\t\t\t");
                          if (_jspx_meth_aui_option_9((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_select_3, _jspx_page_context))
                            return;
                          out.write("\n\n\t\t\t\t\t\t\t\t\t\t");
                          ...
                          _jspx_th_aui_option_10.setLabel( i );
                          _jspx_th_aui_option_10.setSelected( siteNavigationMenuDisplayContext.getDisplayDepth() == i );
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspx_meth_portlet_namespace_11((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("selectSiteNavigationMenuType').val();\n\n\t\t\tvar uri = '");
          ...
          out.print( PortalUtil.getPortletNamespace(ItemSelectorPortletKeys.ITEM_SELECTOR) );
          out.write("siteNavigationMenuType=' + selectSiteNavigationMenuType, uri);\n\n\t\t\tvar itemSelectorDialog = new A.LiferayItemSelectorDialog(\n\t\t\t\t{\n\t\t\t\t\teventName: '");
          ...
          if (_jspx_meth_portlet_namespace_20((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("rootMenuItemName').text(selectedItem.name);\n\n\t\t\t\t\t\t$('#");
  ...
  private boolean _jspx_meth_aui_option_5(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_select_1, PageContext _jspx_page_context)
    ...
    _jspx_th_aui_option_5.setLabel(new String("level"));
    _jspx_th_aui_option_5.setValue(new String("absolute"));
  ...
  private boolean _jspx_meth_aui_option_6(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_select_1, PageContext _jspx_page_context)
    ...
    _jspx_th_aui_option_6.setLabel(new String("level-relative-to-the-current-menu-item"));
    _jspx_th_aui_option_6.setValue(new String("relative"));
  ...
  private boolean _jspx_meth_aui_option_7(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_select_1, PageContext _jspx_page_context)
    ...
    _jspx_th_aui_option_7.setLabel(new String("select"));
    _jspx_th_aui_option_7.setValue(new String("select"));
  ...
  private boolean _jspx_meth_portlet_namespace_4(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_col_3, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  portlet:namespace
    ...
    _jspx_th_portlet_namespace_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_col_3);
  ...
  private boolean _jspx_meth_aui_icon_1(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_col_3, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  aui:icon
    ...
    _jspx_th_aui_icon_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_col_3);
  ...
  private boolean _jspx_meth_aui_option_9(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_select_3, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  aui:option
    ...
    _jspx_th_aui_option_9.setLabel(new String("unlimited"));
  ...
  private boolean _jspx_meth_aui_option_11(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_select_4, PageContext _jspx_page_context)
    ...
    _jspx_th_aui_option_11.setLabel(new String("auto"));
  ...
  private boolean _jspx_meth_aui_option_12(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_select_4, PageContext _jspx_page_context)
    ...
    _jspx_th_aui_option_12.setLabel(new String("all"));
