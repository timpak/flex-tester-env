...
String openId = ParamUtil.getString(request, "openId");
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_liferay$1ui_error_5.setException( StrangersNotAllowedException.class );
        _jspx_th_liferay$1ui_error_5.setMessage("only-known-users-are-allowed-to-sign-in-using-an-openid");
        ...
        _jspx_th_liferay$1ui_error_6.setException( UserEmailAddressException.MustNotBeDuplicate.class );
        _jspx_th_liferay$1ui_error_6.setMessage("the-email-address-associated-with-your-openid-account-is-already-being-used");
        ...
        _jspx_th_liferay$1ui_error_7.setException( UserEmailAddressException.MustNotUseCompanyMx.class );
        _jspx_th_liferay$1ui_error_7.setMessage("the-email-address-associated-with-your-openid-cannot-be-used-to-register-a-new-user-because-its-email-domain-is-reserved");
