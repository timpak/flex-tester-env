...
IFramePortletInstanceConfiguration iFramePortletInstanceConfiguration = iFrameDisplayContext.getIFramePortletInstanceConfiguration();
      ...
      _jspx_th_c_if_1.setTest( iFramePortletInstanceConfiguration.auth() && StringUtil.equals(iFramePortletInstanceConfiguration.authType(), "basic") );
      ...
      if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_aui_script_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            ...
            out.print( iFramePortletInstanceConfiguration.basicUserName() );
            out.write(':');
            out.print( iFramePortletInstanceConfiguration.basicPassword() );
            out.write("'))\n\n\t\tfetch(\n\t\t\t'");
            out.print( HtmlUtil.escapeHREF(iFrameDisplayContext.getIframeSrc()) );
            out.write("',\n\t\t\t{\n\t\t\t\theaders: headers,\n\t\t\t\tmethod: 'GET',\n\t\t\t\tmode: 'no-cors'\n\t\t\t}\n\t\t);\n\t");
