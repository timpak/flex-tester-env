...
public final class document_005flibrary_005fopener_005fgoogle_005fdrive_jsp extends org.apache.jasper.runtime.HttpJspBase
...
DLOpenerGoogleDriveCompanyConfiguration dlOpenerGoogleDriveCompanyConfiguration = (DLOpenerGoogleDriveCompanyConfiguration)request.getAttribute(DLOpenerGoogleDriveCompanyConfiguration.class.getName());
      ...
      _jspx_th_aui_input_0.setValue(new String("/portal_settings/document_library_opener_google_drive"));
      ...
      _jspx_th_aui_input_1.setLabel("client-id");
      _jspx_th_aui_input_1.setName( PortalSettingsDLOpenerGoogleDriveConstants.FORM_PARAMETER_NAMESPACE + "clientId" );
      _jspx_th_aui_input_1.setValue( dlOpenerGoogleDriveCompanyConfiguration.clientId() );
      ...
      _jspx_th_aui_input_2.setLabel("client-secret");
      _jspx_th_aui_input_2.setName( PortalSettingsDLOpenerGoogleDriveConstants.FORM_PARAMETER_NAMESPACE + "clientSecret" );
      _jspx_th_aui_input_2.setValue( dlOpenerGoogleDriveCompanyConfiguration.clientSecret() );
