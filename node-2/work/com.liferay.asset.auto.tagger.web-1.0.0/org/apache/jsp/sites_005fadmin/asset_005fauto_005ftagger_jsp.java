...
AssetAutoTaggerConfiguration assetAutoTaggerConfiguration = (AssetAutoTaggerConfiguration)request.getAttribute(AssetAutoTaggerConfiguration.class.getName());
      ...
      _jspx_th_aui_input_0.setHelpMessage("site-asset-auto-tagging-help");
      _jspx_th_aui_input_0.setLabel("enable-auto-tagging-of-assets-on-this-site");
      _jspx_th_aui_input_0.setName("TypeSettingsProperties--assetAutoTaggingEnabled--");
      _jspx_th_aui_input_0.setType("toggle-switch");
      _jspx_th_aui_input_0.setValue( assetAutoTaggerConfiguration.isEnabled() );
