...
String redirect = ParamUtil.getString(renderRequest, "redirect");
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_liferay$1ui_error_0.setKey("MustNotUseCompanyMx");
        _jspx_th_liferay$1ui_error_0.setMessage("the-email-address-associated-with-your-openid-connect-account-cannot-be-used-to-register-a-new-user-because-its-email-domain-is-reserved");
        ...
        _jspx_th_liferay$1ui_error_1.setKey("StrangersNotAllowedException");
        _jspx_th_liferay$1ui_error_1.setMessage("only-known-users-are-allowed-to-sign-in-using-openid-connect");
        ...
        _jspx_th_liferay$1ui_error_2.setException( OpenIdConnectServiceException.AuthenticationException.class );
        _jspx_th_liferay$1ui_error_2.setMessage("an-error-occurred-while-attempting-to-authenticate-with-the-openid-connect-provider");
        ...
        _jspx_th_liferay$1ui_error_3.setException( OpenIdConnectServiceException.ProviderException.class );
        _jspx_th_liferay$1ui_error_3.setMessage("an-error-occurred-while-attempting-to-communicate-with-the-openid-connect-provider");
        ...
        _jspx_th_liferay$1ui_error_4.setException( OpenIdConnectServiceException.TokenException.class );
        _jspx_th_liferay$1ui_error_4.setMessage("an-error-occurred-while-parsing-the-token-from-the-openid-connect-provider");
        ...
        _jspx_th_liferay$1ui_error_5.setException( OpenIdConnectServiceException.UserInfoException.class );
        _jspx_th_liferay$1ui_error_5.setMessage("an-error-occurred-while-retrieving-user-info-from-the-openid-connect-provider");
        ...
        _jspx_th_liferay$1ui_error_6.setException( OpenIdConnectServiceException.UserMappingException.class );
        _jspx_th_liferay$1ui_error_6.setMessage("unable-to-obtain-user-info-from-the-openid-connect-provider");
