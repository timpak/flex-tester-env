...
if (assetEntry != null) {
	...
	if (Validator.isNotNull(data)) {
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( structureJSONArray != null );
		...
		try {
          ...
          out.write("\n\n\t\t\t\t\t\t\t\t\t\t\t");
          out.print( FragmentEntryRenderUtil.renderFragmentEntryLink(fragmentEntryLink, FragmentEntryLinkConstants.ASSET_DISPLAY_PAGE, assetDisplayLayoutTypeControllerDisplayContext.getAssetDisplayFieldsValues(), request, response, locale) );
          out.write("\n\n\t\t\t\t\t\t\t\t\t\t");
