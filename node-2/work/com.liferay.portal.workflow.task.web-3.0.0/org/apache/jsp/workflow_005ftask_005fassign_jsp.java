...
String redirect = ParamUtil.getString(request, "redirect");
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_button_1.setDisabled( !hasOtherAssignees && (assigneeUserId <= 0) );
        _jspx_th_aui_button_1.setName("done");
        _jspx_th_aui_button_1.setPrimary( true );
        _jspx_th_aui_button_1.setValue("done");
  ...
  private boolean _jspx_meth_aui_button_0(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_aui_button_0.setName("close");
