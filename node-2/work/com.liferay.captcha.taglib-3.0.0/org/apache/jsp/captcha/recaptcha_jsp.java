...
if (portletRequest != null) {
	...
	captchaEnabled = CaptchaUtil.isEnabled(request);
      ...
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        out.write("\n\t<script src=\"");
        out.print( HtmlUtil.escapeAttribute(captchaConfiguration.reCaptchaScriptURL()) );
        out.write("?hl=");
        out.print( HtmlUtil.escapeAttribute(locale.getLanguage()) );
        out.write("\" type=\"text/javascript\"></script>\n\n\t<div class=\"g-recaptcha\" data-sitekey=\"");
        out.print( HtmlUtil.escapeAttribute(captchaConfiguration.reCaptchaPublicKey()) );
        out.write("\"></div>\n\n\t<noscript>\n\t\t<div style=\"height: 525px; width: 302px;\">\n\t\t\t<div style=\"height: 525px; position: relative; width: 302px;\">\n\t\t\t\t<div style=\"height: 525px; position: absolute; width: 302px;\">\n\t\t\t\t\t<iframe frameborder=\"0\" scrolling=\"no\" src=\"");
        out.print( HtmlUtil.escapeAttribute(captchaConfiguration.reCaptchaNoScriptURL()) );
        out.print( HtmlUtil.escapeAttribute(captchaConfiguration.reCaptchaPublicKey()) );
