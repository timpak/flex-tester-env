      ...
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            out.print( DLURLHelperUtil.getPreviewURL(fileEntry, fileVersion, themeDisplay, "&imageThumbnail=1") );
            out.write("\" style=\"");
          ...
          if (_jspx_eval_c_when_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_tagPool_liferay$1ui_message_key_escapeAttribute_nobody.reuse(_jspx_th_liferay$1ui_message_1);
            out.write("\" class=\"img-thumbnail\" src=\"");
            out.print( DLURLHelperUtil.getPreviewURL(fileEntry, fileVersion, themeDisplay, "&documentThumbnail=1") );
            out.write("\" style=\"");
            out.print( DLUtil.getThumbnailStyle(true, 0, 128, 128) );
            out.write("\" />\n\t\t\t\t</div>\n\n\t\t\t\t<p class=\"asset-description\">\n\t\t\t\t\t");
            out.print( HtmlUtil.replaceNewLine(HtmlUtil.escape(StringUtil.shorten(fileEntry.getDescription(), abstractLength))) );
          ...
          if (_jspx_eval_c_when_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_tagPool_liferay$1ui_message_key_escapeAttribute_nobody.reuse(_jspx_th_liferay$1ui_message_2);
            out.write("\" class=\"img-thumbnail\" src=\"");
            out.print( DLURLHelperUtil.getPreviewURL(fileEntry, fileVersion, themeDisplay, "&videoThumbnail=1") );
            out.write("\" style=\"");
            out.print( DLUtil.getThumbnailStyle(true, 0, 128, 128) );
            out.write("\" />\n\t\t\t\t</div>\n\n\t\t\t\t<p class=\"asset-description\">\n\t\t\t\t\t");
            out.print( HtmlUtil.replaceNewLine(HtmlUtil.escape(StringUtil.shorten(fileEntry.getDescription(), abstractLength))) );
