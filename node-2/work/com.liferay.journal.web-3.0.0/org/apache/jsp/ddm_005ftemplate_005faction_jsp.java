...
public final class ddm_005ftemplate_005faction_jsp extends org.apache.jasper.runtime.HttpJspBase
...
DDMTemplate ddmTemplate = (DDMTemplate)row.getObject();
      ...
      if (_jspx_eval_liferay$1ui_icon$1menu_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jspx_th_c_if_0.setTest( DDMTemplatePermission.contains(permissionChecker, ddmTemplate, ActionKeys.UPDATE) );
          ...
          _jspx_th_c_if_1.setTest( DDMTemplatePermission.contains(permissionChecker, ddmTemplate, ActionKeys.PERMISSIONS) );
          ...
          if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_liferay$1security_permissionsURL_0.setModelResource( DDMTemplatePermission.getTemplateModelResourceName(ddmTemplate.getResourceClassNameId()) );
            _jspx_th_liferay$1security_permissionsURL_0.setModelResourceDescription( ddmTemplate.getName(locale) );
            _jspx_th_liferay$1security_permissionsURL_0.setResourcePrimKey( String.valueOf(ddmTemplate.getTemplateId()) );
	...
	Group scopeGroup = themeDisplay.getScopeGroup();
          ...
          _jspx_th_c_if_2.setTest( (!scopeGroup.hasLocalOrRemoteStagingGroup() || scopeGroup.isStagingGroup()) && DDMTemplatePermission.containsAddTemplatePermission(permissionChecker, scopeGroupId, ddmTemplate.getClassNameId(), ddmTemplate.getResourceClassNameId()) );
          ...
          if (_jspx_eval_c_if_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            if (_jspx_eval_portlet_renderURL_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_portlet_param_5.setName("ddmTemplateId");
              _jspx_th_portlet_param_5.setValue( String.valueOf(ddmTemplate.getTemplateId()) );
          ...
          _jspx_th_c_if_3.setTest( DDMTemplatePermission.contains(permissionChecker, ddmTemplate, ActionKeys.DELETE) );
          ...
          if (_jspx_eval_c_if_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            if (_jspx_eval_portlet_actionURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_portlet_param_8.setName("ddmTemplateId");
              _jspx_th_portlet_param_8.setValue( String.valueOf(ddmTemplate.getTemplateId()) );
  ...
  private boolean _jspx_meth_portlet_param_3(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_renderURL_1, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_3.setValue("/copy_ddm_template.jsp");
  ...
  private boolean _jspx_meth_portlet_param_6(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_actionURL_0, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_6.setValue("/view_ddm_templates.jsp");
