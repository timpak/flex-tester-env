...
LayoutPrototypeManagementToolbarDisplayContext layoutPrototypeManagementToolbarDisplayContext = new LayoutPrototypeManagementToolbarDisplayContext(liferayPortletRequest, liferayPortletResponse, request, layoutPrototypeDisplayContext);
      ...
      _jspx_th_clay_management$1toolbar_0.setDisplayContext( layoutPrototypeManagementToolbarDisplayContext );
			...
			row.setCssClass("entry-card lfr-asset-item");
              ...
              if (_jspx_eval_liferay$1ui_search$1container$1column$1text_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  _jspx_th_clay_vertical$1card_0.setVerticalCard( new LayoutPrototypeVerticalCard(layoutPrototype, renderRequest, renderResponse, searchContainer.getRowChecker()) );
      ...
      _jspx_th_liferay$1frontend_component_0.setComponentId( LayoutAdminWebKeys.LAYOUT_PROTOTYPE_DROPDOWN_DEFAULT_EVENT_HANDLER );
      _jspx_th_liferay$1frontend_component_0.setModule("js/LayoutPrototypeDropdownDefaultEventHandler.es");
      ...
      _jspx_th_liferay$1frontend_component_1.setComponentId( layoutPrototypeManagementToolbarDisplayContext.getDefaultEventHandler() );
      _jspx_th_liferay$1frontend_component_1.setModule("js/LayoutPrototypeManagementToolbarDefaultEventHandler.es");
