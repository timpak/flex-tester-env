...
renderResponse.setTitle(LanguageUtil.get(request, "select-template"));
      ...
      out.write("\n\n<div class=\"container-fluid container-fluid-max-xl container-view\" id=\"");
      ...
      if (_jspx_eval_c_choose_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_4.setTest( selectLayoutPageTemplateEntryDisplayContext.isBasicPages() );
  ...
  private boolean _jspx_meth_aui_script_0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\n\tvar addLayoutActionOptionQueryClickHandler = A.one('#");
        if (_jspx_meth_portlet_namespace_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
          return true;
        out.write("layoutPageTemplateEntries').delegate(\n\t\t'click',\n\t\tfunction(event) {\n\t\t\tvar actionElement = event.currentTarget;\n\n\t\t\tLiferay.Util.openWindow(\n\t\t\t\t{\n\t\t\t\t\tdialog: {\n\t\t\t\t\t\tdestroyOnHide: true,\n\t\t\t\t\t\theight: 480,\n\t\t\t\t\t\tresizable: false,\n\t\t\t\t\t\twidth: 640\n\t\t\t\t\t},\n\t\t\t\t\tdialogIframe: {\n\t\t\t\t\t\tbodyCssClass: 'dialog-with-footer'\n\t\t\t\t\t},\n\t\t\t\t\tid: '");
