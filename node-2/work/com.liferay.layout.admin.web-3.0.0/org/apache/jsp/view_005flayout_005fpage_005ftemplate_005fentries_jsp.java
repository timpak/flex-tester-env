...
LayoutPageTemplateManagementToolbarDisplayContext layoutPageTemplateManagementToolbarDisplayContext = new LayoutPageTemplateManagementToolbarDisplayContext(liferayPortletRequest, liferayPortletResponse, request, layoutPageTemplateDisplayContext);
      ...
      _jspx_th_clay_management$1toolbar_0.setDisplayContext( new LayoutPageTemplateManagementToolbarDisplayContext(liferayPortletRequest, liferayPortletResponse, request, layoutPageTemplateDisplayContext) );
			...
			row.setCssClass("entry-card lfr-asset-item " + row.getCssClass());
              ...
              if (_jspx_eval_liferay$1ui_search$1container$1column$1text_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  _jspx_th_clay_vertical$1card_0.setVerticalCard( new LayoutPageTemplateEntryVerticalCard(layoutPageTemplateEntry, renderRequest, renderResponse, searchContainer.getRowChecker()) );
      ...
      _jspx_th_liferay$1frontend_component_0.setComponentId( LayoutAdminWebKeys.LAYOUT_PAGE_TEMPLATE_ENTRY_DROPDOWN_DEFAULT_EVENT_HANDLER );
      _jspx_th_liferay$1frontend_component_0.setModule("js/LayoutPageTemplateEntryDropdownDefaultEventHandler.es");
      ...
      _jspx_th_liferay$1frontend_component_1.setComponentId( layoutPageTemplateManagementToolbarDisplayContext.getDefaultEventHandler() );
      _jspx_th_liferay$1frontend_component_1.setModule("js/LayoutPageTemplateEntryManagementToolbarDefaultEventHandler.es");
