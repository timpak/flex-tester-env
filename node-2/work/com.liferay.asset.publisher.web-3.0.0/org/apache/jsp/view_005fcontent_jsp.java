...
if (Validator.isNotNull(urlTitle)) {
	...
	assetRenderer = assetRendererFactory.getAssetRenderer(assetEntry.getClassPK());
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( (assetEntry.isVisible() && !assetPublisherDisplayContext.isEnablePermissions()) || (assetRenderer.hasViewPermission(permissionChecker) && assetRenderer.isDisplayable()) );
