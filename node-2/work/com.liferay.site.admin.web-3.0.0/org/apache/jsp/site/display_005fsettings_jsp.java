...
if (publicLayoutSet.isLayoutSetPrototypeLinkEnabled() || privateLayoutSet.isLayoutSetPrototypeLinkEnabled()) {
	disabledLocaleInput = true;
      ...
      _jspx_th_aui_fieldset_0.setId( renderResponse.getNamespace() + "inheritLocalesFieldset" );
      ...
      if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_aui_fieldset_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          if (_jspx_meth_liferay$1ui_message_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_fieldset_2, _jspx_page_context))
            return;
          out.write("</h4>\n\n\t\t<p class=\"text-muted\">\n\t\t\t");
          out.print( StringUtil.merge(LocaleUtil.toDisplayNames(LanguageUtil.getAvailableLocales(), locale), StringPool.COMMA_AND_SPACE) );
          out.write("\n\t\t</p>\n\t");
        }
      ...
      _jspx_th_aui_fieldset_3.setId( renderResponse.getNamespace() + "customLocalesFieldset" );
  ...
  private boolean _jspx_meth_liferay$1ui_message_4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_4.setKey("you-cannot-remove-a-language-that-is-the-current-default-language");
