...
if (ldapContext != null) {
  ...
  private boolean _jspx_meth_liferay$1ui_message_3(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_3.setKey("please-enter-a-valid-ldap-base-dn");
  ...
  private boolean _jspx_meth_liferay$1ui_message_4(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_4.setKey("test-ldap-users");
  ...
  private boolean _jspx_meth_liferay$1ui_message_5(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_5.setKey("a-subset-of-users-has-been-displayed-for-you-to-review");
  ...
  private boolean _jspx_meth_liferay$1ui_message_6(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_6.setKey("the-above-results-include-users-which-are-missing-the-required-attributes-(screen-name,-password,-email-address,-first-name,-and-last-name).-these-users-will-not-be-imported-until-these-attributes-are-filled-in");
