...
SharingConfiguration sharingConfiguration = (SharingConfiguration)request.getAttribute(SharingConfiguration.class.getName());
      ...
      _jspx_th_aui_input_0.setValue(new String("/portal_settings/sharing"));
      ...
      _jspx_th_aui_input_1.setName( PortalSettingsSharingConstants.FORM_PARAMETER_NAMESPACE + "enabled" );
      _jspx_th_aui_input_1.setType("toggle-switch");
      _jspx_th_aui_input_1.setValue( sharingConfiguration.isEnabled() );
