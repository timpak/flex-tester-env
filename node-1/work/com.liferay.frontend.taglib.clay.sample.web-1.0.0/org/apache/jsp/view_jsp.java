...
TablesDisplayContext tablesDisplayContext = (TablesDisplayContext)request.getAttribute(ClaySamplePortletKeys.TABLES_DISPLAY_CONTEXT);
      ...
      _jspx_th_liferay$1ui_tabs_0.setNames("Alerts,Badges,Buttons,Cards,Dropdowns,Form Elements,Icons,Labels,Links,Management Toolbars,Navigation Bars,Progress Bars,Stickers,Tables");
