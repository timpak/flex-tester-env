...
if (ddmStructure != null) {
	renderResponse.setTitle(LanguageUtil.format(request, "templates-for-structure-x", ddmStructure.getName(locale)));
      ...
      _jspx_th_clay_navigation$1bar_0.setNavigationItems( journalDisplayContext.getNavigationBarItems("templates") );
      ...
      _jspx_th_clay_management$1toolbar_0.setActionDropdownItems( journalDDMTemplateDisplayContext.getActionItemsDropdownItems() );
      _jspx_th_clay_management$1toolbar_0.setClearResultsURL( journalDDMTemplateDisplayContext.getClearResultsURL() );
      _jspx_th_clay_management$1toolbar_0.setComponentId("ddmTemplateManagementToolbar");
      _jspx_th_clay_management$1toolbar_0.setCreationMenu( journalDDMTemplateDisplayContext.isShowAddButton() ? journalDDMTemplateDisplayContext.getCreationMenu() : null );
      _jspx_th_clay_management$1toolbar_0.setDisabled( journalDDMTemplateDisplayContext.isDisabledManagementBar() );
      _jspx_th_clay_management$1toolbar_0.setFilterDropdownItems( journalDDMTemplateDisplayContext.getFilterItemsDropdownItems() );
      _jspx_th_clay_management$1toolbar_0.setItemsTotal( journalDDMTemplateDisplayContext.getTotalItems() );
      _jspx_th_clay_management$1toolbar_0.setSearchActionURL( journalDDMTemplateDisplayContext.getSearchActionURL() );
      _jspx_th_clay_management$1toolbar_0.setSearchContainerId("ddmTemplates");
      _jspx_th_clay_management$1toolbar_0.setSelectable( !user.isDefaultUser() );
      _jspx_th_clay_management$1toolbar_0.setSortingOrder( journalDDMTemplateDisplayContext.getOrderByType() );
      _jspx_th_clay_management$1toolbar_0.setSortingURL( journalDDMTemplateDisplayContext.getSortingURL() );
        ...
        if (_jspx_eval_liferay$1ui_search$1container_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          if (_jspx_eval_liferay$1ui_search$1container$1row_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
			...
			if (DDMTemplatePermission.contains(permissionChecker, ddmTemplate, ActionKeys.UPDATE)) {
              ...
              if (_jspx_eval_liferay$1ui_search$1container$1column$1text_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                    ...
                    _jspx_th_c_when_0.setTest( ddmTemplate.isSmallImage() );
                    ...
                    if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      out.write("\n\t\t\t\t\t\t");
                      out.print( HtmlUtil.escape(ddmTemplate.getDescription(locale)) );
                      out.write("\n\t\t\t\t\t");
                    }
              ...
              _jspx_th_c_if_0.setTest( journalDDMTemplateDisplayContext.getClassPK() <= 0 );
              ...
              if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                _jspx_th_liferay$1ui_search$1container$1column$1text_3.setName("structure");
                _jspx_th_liferay$1ui_search$1container$1column$1text_3.setValue( HtmlUtil.escape(ddmStructureName) );
              ...
              _jspx_th_liferay$1ui_search$1container$1column$1text_4.setName("language");
              _jspx_th_liferay$1ui_search$1container$1column$1text_4.setValue( LanguageUtil.get(request, HtmlUtil.escape(ddmTemplate.getLanguage()) + "[stands-for]") );
  ...
  private boolean _jspx_meth_liferay$1ui_search$1container$1column$1jsp_0(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1ui_search$1container$1row_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_search$1container$1column$1jsp_0.setPath("/ddm_template_action.jsp");
