...
String npmResolvedPackageName = (String)request.getAttribute("liferay-form:ddm-form-builder:npmResolvedPackageName");
...
String serializedDDMFormRules = (String)request.getAttribute("liferay-form:ddm-form-builder:serializedDDMFormRules");
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("/alloy/templates/autocomplete.es',\n\t\t\t'");
          out.print( npmResolvedPackageName );
          out.write("/alloy/templates/calculate.es',\n\t\t\t'");
          out.print( npmResolvedPackageName );
          out.write("/alloy/templates/calculator.es',\n\t\t\t'");
          out.print( npmResolvedPackageName );
          out.write("/alloy/templates/data-provider-parameter.es',\n\t\t\t'");
          out.print( npmResolvedPackageName );
          out.write("/alloy/templates/field-options-toolbar.es',\n\t\t\t'");
          out.print( npmResolvedPackageName );
          out.write("/alloy/templates/field-types-sidebar.es',\n\t\t\t'");
          out.print( npmResolvedPackageName );
          out.write("/alloy/templates/rule-builder.es',\n\t\t\t'");
          out.print( npmResolvedPackageName );
          out.write("/alloy/templates/rule.es',\n\t\t\t'");
          out.print( npmResolvedPackageName );
          out.write("/alloy/templates/sidebar.es',\n\t\t\tinitTagLib\n\t\t]\n\t);\n");
