...
renderResponse.setTitle((formInstance == null) ? LanguageUtil.get(request, "new-form") : LanguageUtil.get(request, "edit-form"));
	...
	DDMFormValidationException.MustSetValidValidationExpression msvve = (DDMFormValidationException.MustSetValidValidationExpression)errorException;
            ...
            _jspx_th_liferay$1ui_message_6.setArguments( new Object[] {StringBundler.concat("<b>", HtmlUtil.escape(msvve.getValidationExpressionArgument()), "</b>"), StringBundler.concat("<b>", HtmlUtil.escape(msvve.getFieldName()), "</b>")} );
	...
	sb.setIndex(sb.index() - 1);
        ...
        _jspx_th_aui_script_1.setUse("aui-promise,liferay-ddm-form-portlet");
  ...
  private boolean _jspx_meth_aui_script_2(PageContext _jspx_page_context)
    ...
    _jspx_th_aui_script_2.setRequire("metal-clipboard/src/Clipboard");
    ...
    if (_jspx_eval_aui_script_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        if (_jspx_meth_liferay$1ui_message_15((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_2, _jspx_page_context))
          return true;
        out.write("');\n\t\t}\n\t);\n\n\tLiferay.on(\n\t\t'destroyPortlet',\n\t\tfunction() {\n\t\t\tclipboard.dispose();\n\t\t}\n\t);\n");
  ...
  private boolean _jspx_meth_liferay$1ui_message_15(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_script_2, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  liferay-ui:message
    ...
    _jspx_th_liferay$1ui_message_15.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_script_2);
