...
public final class google_005fcloud_005fvision_005fauto_005ftag_005fprovider_jsp extends org.apache.jasper.runtime.HttpJspBase
...
GoogleCloudVisionAssetAutoTagProviderCompanyConfiguration googleCloudVisionAssetAutoTagProviderCompanyConfiguration = (GoogleCloudVisionAssetAutoTagProviderCompanyConfiguration)request.getAttribute(GoogleCloudVisionAssetAutoTagProviderCompanyConfiguration.class.getName());
      ...
      _jspx_th_aui_input_0.setValue(new String("/portal_settings/document_library_asset_auto_tagger_google_cloud_vision"));
      ...
      _jspx_th_aui_input_1.setName( PortalSettingsGoogleCloudVisionAssetAutoTagProviderConstants.FORM_PARAMETER_NAMESPACE + "enabled" );
      _jspx_th_aui_input_1.setType("checkbox");
      _jspx_th_aui_input_1.setValue( googleCloudVisionAssetAutoTagProviderCompanyConfiguration.enabled() );
      ...
      _jspx_th_aui_input_2.setHelpMessage( LanguageUtil.format(resourceBundle, "api-key-description", new String[] {GoogleCloudVisionAssetAutoTagProviderConstants.API_KEY_DOCS_URL}, false) );
      _jspx_th_aui_input_2.setId("api-key");
      _jspx_th_aui_input_2.setLabel("api-key");
      _jspx_th_aui_input_2.setName( PortalSettingsGoogleCloudVisionAssetAutoTagProviderConstants.FORM_PARAMETER_NAMESPACE + "apiKey" );
      _jspx_th_aui_input_2.setValue( googleCloudVisionAssetAutoTagProviderCompanyConfiguration.apiKey() );
