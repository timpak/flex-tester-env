...
context.put("videoPosterURL", (String)request.getAttribute(DLPreviewVideoWebKeys.VIDEO_POSTER_URL));
      ...
      _jspx_th_liferay$1util_html$1top_0.setOutputKey("document_library_preview_video_css");
      ...
      if (_jspx_eval_liferay$1util_html$1top_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n\t<link href=\"");
          out.print( PortalUtil.getStaticResourceURL(request, application.getContextPath() + "/preview/css/main.css") );
      ...
      _jspx_th_soy_component$1renderer_0.setComponentId( renderResponse.getNamespace() + randomNamespace + "previewVideo" );
      _jspx_th_soy_component$1renderer_0.setContext( context );
      _jspx_th_soy_component$1renderer_0.setModule("preview/js/VideoPreviewer.es");
      _jspx_th_soy_component$1renderer_0.setTemplateNamespace("com.liferay.document.library.preview.VideoPreviewer.render");
