...
Format dateFormatDate = FastDateFormatFactoryUtil.getDate(locale, timeZone);
      ...
      if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        out.write('	');
        //  aui:input
        com.liferay.taglib.aui.InputTag _jspx_th_aui_input_0 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_value_type_onChange_name_label_id_checked_nobody.get(com.liferay.taglib.aui.InputTag.class);
        _jspx_th_aui_input_0.setPageContext(_jspx_page_context);
        _jspx_th_aui_input_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
        _jspx_th_aui_input_0.setChecked( assetPublisherDisplayContext.isSelectionStyleDynamic() );
        _jspx_th_aui_input_0.setId("selectionStyleDynamic");
        _jspx_th_aui_input_0.setLabel("dynamic");
        _jspx_th_aui_input_0.setName("preferences--selectionStyle--");
        _jspx_th_aui_input_0.setOnChange( renderResponse.getNamespace() + "chooseSelectionStyle();" );
        _jspx_th_aui_input_0.setType("radio");
        _jspx_th_aui_input_0.setValue(new String("dynamic"));
        int _jspx_eval_aui_input_0 = _jspx_th_aui_input_0.doStartTag();
        if (_jspx_th_aui_input_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          _jspx_tagPool_aui_input_value_type_onChange_name_label_id_checked_nobody.reuse(_jspx_th_aui_input_0);
          return;
        }
        _jspx_tagPool_aui_input_value_type_onChange_name_label_id_checked_nobody.reuse(_jspx_th_aui_input_0);
        out.write("\n\n\t");
        ...
        _jspx_th_aui_input_1.setChecked( assetPublisherDisplayContext.isSelectionStyleManual() );
        _jspx_th_aui_input_1.setId("selectionStyleManual");
        _jspx_th_aui_input_1.setLabel("manual");
        ...
        _jspx_th_aui_input_1.setValue(new String("manual"));
        ...
        _jspx_th_aui_input_2.setChecked( assetPublisherDisplayContext.isSelectionStyleAssetList() );
        _jspx_th_aui_input_2.setId("selectionStyleAssetList");
        _jspx_th_aui_input_2.setLabel("asset-list");
        ...
        _jspx_th_aui_input_2.setValue(new String("asset-list"));
