...
AssetListEntry assetListEntry = assetPublisherDisplayContext.fetchAssetListEntry();
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( assetListEntry != null );
      ...
      _jspx_tagPool_c_choose.reuse(_jspx_th_c_choose_0);
      out.write("\n\t\t</span>\n\n\t\t<div class=\"d-inline-block ");
      out.print( (assetListEntry == null) ? "hide" : StringPool.BLANK );
      out.write("\" id=\"");
      if (_jspx_meth_portlet_namespace_1(_jspx_page_context))
        return;
      out.write("assetListRemove\" role=\"button\">\n\t\t\t");
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n\tvar assetListEntryId = A.one('#");
          if (_jspx_meth_portlet_namespace_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("assetListEntryId');\n\tvar assetListRemove = A.one('#");
          if (_jspx_meth_portlet_namespace_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("assetListRemove');\n\tvar assetListTitle = A.one('#");
          if (_jspx_meth_portlet_namespace_4((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("assetListTitle');\n\n\tA.one('#");
          if (_jspx_meth_portlet_namespace_5((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("selectAssetList').on(\n\t\t'click',\n\t\tfunction(event) {\n\t\t\tLiferay.Util.selectEntity(\n\t\t\t\t{\n\t\t\t\t\tdialog: {\n\t\t\t\t\t\tconstrain: true,\n\t\t\t\t\t\tdestroyOnHide: true\n\t\t\t\t\t},\n\t\t\t\t\teventName: '");
  ...
  private boolean _jspx_meth_aui_button_0(PageContext _jspx_page_context)
    ...
    _jspx_th_aui_button_0.setName("selectAssetList");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_script_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("select-asset-list");
