...
PortletURL configurationRenderURL = (PortletURL)request.getAttribute("configuration.jsp-configurationRenderURL");
      ...
      _jspx_th_liferay$1ddm_template$1selector_0.setDefaultDisplayStyle( assetPublisherDisplayContext.getDefaultDisplayStyle() );
      ...
      _jspx_th_liferay$1ddm_template$1selector_0.setDisplayStyles( Arrays.asList(assetPublisherDisplayContext.getDisplayStyles()) );
	...
	for (String paginationType : assetPublisherDisplayContext.PAGINATION_TYPES) {
      ...
      _jspx_th_c_if_0.setTest( !assetPublisherDisplayContext.isSearchWithIndex() );
