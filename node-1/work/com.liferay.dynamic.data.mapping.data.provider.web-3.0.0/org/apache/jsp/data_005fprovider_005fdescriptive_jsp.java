...
DDMDataProviderInstance ddmDataProviderInstance = (DDMDataProviderInstance)row.getObject();
      ...
      _jspx_th_aui_a_0.setHref( (String)request.getAttribute(WebKeys.SEARCH_ENTRY_HREF) );
      int _jspx_eval_aui_a_0 = _jspx_th_aui_a_0.doStartTag();
      if (_jspx_eval_aui_a_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        out.write("\n\t\t\t");
        out.print( HtmlUtil.escape(ddmDataProviderInstance.getName(locale)) );
        out.write("\n\t\t");
      }
      ...
      out.print( HtmlUtil.escape(ddmDataProviderInstance.getDescription(locale)) );
      out.write("\n\t\t</div>\n\t</h5>\n\n\t<h5 class=\"text-default\">\n\t\t<span class=\"data-provider-instance-id\">\n\t\t\t");
      if (_jspx_meth_liferay$1ui_message_0(_jspx_page_context))
        return;
      out.write(':');
      out.write(' ');
      out.print( ddmDataProviderInstance.getDataProviderInstanceId() );
