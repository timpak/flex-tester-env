...
boolean checkedOut = GetterUtil.getBoolean(request.getAttribute("edit_file_entry.jsp-checkedOut"));
      ...
      if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_0.setName("versionDetailsVersionIncrease");
        _jspx_th_aui_input_0.setType("radio");
        _jspx_th_aui_input_0.setValue( DLVersionNumberIncrease.MAJOR );
        ...
        _jspx_th_aui_input_1.setName("versionDetailsVersionIncrease");
        _jspx_th_aui_input_1.setType("radio");
        _jspx_th_aui_input_1.setValue( DLVersionNumberIncrease.MINOR );
        ...
        _jspx_th_aui_input_2.setLabel("keep-current-version-number");
        _jspx_th_aui_input_2.setName("versionDetailsVersionIncrease");
        _jspx_th_aui_input_2.setType("radio");
        _jspx_th_aui_input_2.setValue( DLVersionNumberIncrease.NONE );
  ...
  private boolean _jspx_meth_aui_input_3(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_fieldset_0, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  aui:input
    com.liferay.taglib.aui.InputTag _jspx_th_aui_input_3 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_name_maxLength_label_nobody.get(com.liferay.taglib.aui.InputTag.class);
    _jspx_th_aui_input_3.setPageContext(_jspx_page_context);
    _jspx_th_aui_input_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
    _jspx_th_aui_input_3.setLabel("version-notes");
    _jspx_th_aui_input_3.setDynamicAttribute(null, "maxLength", new String("75"));
    _jspx_th_aui_input_3.setName("versionDetailsChangeLog");
    int _jspx_eval_aui_input_3 = _jspx_th_aui_input_3.doStartTag();
    if (_jspx_th_aui_input_3.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _jspx_tagPool_aui_input_name_maxLength_label_nobody.reuse(_jspx_th_aui_input_3);
      return true;
    }
    _jspx_tagPool_aui_input_name_maxLength_label_nobody.reuse(_jspx_th_aui_input_3);
    return false;
